...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // We attach this to 'window' so the onclick="toggleMenu()" in HTML script can find it
    ...
    // Only run quiz logic if the form exists on the current page
    // Prevents errors when script is on non-quiz pages
    if (quizForm) {
